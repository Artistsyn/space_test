...
pub const PLANETS: &[PlanetDef] = &[
    PlanetDef { name: "terra",    x: WORLD_W * 0.20, y: WORLD_H * 0.30, radius: 400.0, strength: 0.45, r: 60,  g: 140, b: 80,  atmosphere: 0.15 },
    PlanetDef { name: "inferno",  x: WORLD_W * 0.75, y: WORLD_H * 0.25, radius: 300.0, strength: 0.35, r: 200, g: 60,  b: 30,  atmosphere: 0.10 },
    PlanetDef { name: "ice",      x: WORLD_W * 0.15, y: WORLD_H * 0.70, radius: 350.0, strength: 0.4,  r: 140, g: 180, b: 220, atmosphere: 0.20 },
    PlanetDef { name: "giant",    x: WORLD_W * 0.55, y: WORLD_H * 0.75, radius: 600.0, strength: 0.8,  r: 180, g: 140, b: 80,  atmosphere: 0.25 },
    PlanetDef { name: "tiny",     x: WORLD_W * 0.85, y: WORLD_H * 0.60, radius: 180.0, strength: 0.2,  r: 160, g: 100, b: 180, atmosphere: 0.08 },
    PlanetDef { name: "moon_a",   x: WORLD_W * 0.22, y: WORLD_H * 0.35, radius: 120.0, strength: 0.1,  r: 180, g: 180, b: 170, atmosphere: 0.0  },
    PlanetDef { name: "moon_b",   x: WORLD_W * 0.58, y: WORLD_H * 0.80, radius: 140.0, strength: 0.15, r: 200, g: 190, b: 160, atmosphere: 0.0  },
];
